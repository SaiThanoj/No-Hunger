    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId())
        {
            ...
            case R.id.moneydonors:
                ...
                //Toast.makeText(getApplicationContext(),"Item 2 selected",Toast.LENGTH_SHORT).show();
                Intent intent2 = new Intent(getApplicationContext(), money_donorsListActivity.class);
                //intent.putExtra("noteId",i);
            ...
            case R.id.moneyspent:
                ...
                Intent intent3 = new Intent(getApplicationContext(),money_spentListActivity.class);
                //intent.putExtra("noteId",i);
